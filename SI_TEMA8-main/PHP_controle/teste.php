...
<div class="container">
    ...
    <?php
    // Função para verificar se o sensor de incendio foi acionado (simulação)
    function verificarSensorIncendio() {
        // Implemente a lógica real para verificar o sensor de incendio aqui
        // Neste exemplo, vamos simular que o sensor é acionado aleatoriamente
        return rand(0, 1); // Retorna 0 (não acionado) ou 1 (acionado)
    }

    // Função para verificar se o sensor de invasao foi acionado (simulação)
    function verificarSensorInvasao() {
        // Implemente a lógica real para verificar o sensor de invasao aqui
        // Neste exemplo, vamos simular que o sensor é acionado aleatoriamente
        return rand(0, 1); // Retorna 0 (não acionado) ou 1 (acionado)
    }

    // Função para verificar se o sensor de Falta de Energia foi acionado (simulação)
    function verificarSensorFaltaDeEnergia() {
        // Implemente a lógica real para verificar o sensor de Falta de Energia aqui
        // Neste exemplo, vamos simular que o sensor é acionado aleatoriamente
        return rand(0, 1); // Retorna 0 (não acionado) ou 1 (acionado)
    }

    // Função para verificar se o sensor de vazamento de gases foi acionado (simulação)
    function verificarSensorVazamentoDeGases() {
        // Implemente a lógica real para verificar o sensor de vazamento de gases aqui
        // Neste exemplo, vamos simular que o sensor é acionado aleatoriamente
        return rand(0, 1); // Retorna 0 (não acionado) ou 1 (acionado)
    }
    ...
    // Verifica se o sensor de Falta de Energia foi acionado
    if (verificarSensorFaltaDeEnergia()) {
        $sensores_acionados[] = 'Falta de Energia';
    }

    // Verifica se o sensor de vazamento de gases foi acionado
    if (verificarSensorVazamentoDeGases()) {
        $sensores_acionados[] = 'vazamento de gases';
    }
